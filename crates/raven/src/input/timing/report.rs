...
pub(super) struct Window {
    ...
    pub queue_invariant_mismatch: u64,
    pub successor_invariant_mismatch: u64,
    pub snapshots_discarded: u64,
    pub successor_promoted: u64,
    pub successor_submit_failed: u64,
    pub presentations: Presentations,
    pub queue_to_presentation: Samples,
    pub software_residence: Samples,
    pub kms_to_presentation: Samples,
...
pub struct Report {
    ...
    pub(super) successor: bool,
    pub(super) pending_ambiguous: bool,
...
impl fmt::Display for Report {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        write!(
            f,
            "raven: input-timing span={:.3}s clock=CLOCK_MONOTONIC samples=n:min/mean/max scope=observations_not_client_response clock_read_errors={} queued={} deferred_queued={} queue_invariant_mismatch={} successor_invariant_mismatch={} snapshots_discarded={} successor_promoted={} successor_submit_failed={} pending={} successor={} pending_ambiguous={} unqueued_obs={} unflushed_obs={}",
            self.span.as_secs_f64(),
            w.clock_read_errors,
            w.queued,
            w.deferred_queued,
            w.queue_invariant_mismatch,
            w.successor_invariant_mismatch,
            w.snapshots_discarded,
            w.successor_promoted,
            w.successor_submit_failed,
            self.pending,
            self.successor,
        ...
        write!(
            ...
            w.software_residence,
            w.kms_to_presentation,
            w.drm_dispatch,
            w.flushes,
            w.flush_errors,
            w.flush_duration,
